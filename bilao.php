        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-responsive img-curve" src="images/img/logo.jpg" alt="" width="100"> </a>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="bilao.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite food</a></li>
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="bilao.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
...
?>								  
                    ...
                    <div class="col-md-8">
						...
						<?php  
									$stmt = $db->prepare("select * from bilao");
									$stmt->execute();
                               ...
                               <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='bilao.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
