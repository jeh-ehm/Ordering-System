...
.hero{
    background-color: #ff8c00;}
        ...
        <div class="page-wrapper"><section class="hero" data-image-src="images/img/woo.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Browse</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Add to cart</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Order Food</h4> </div>
...
<div class="col-md-8">
						...
						<?php  
                                ...
                                switch ($_GET['res_id']) {
                                    ...
                                    case 11: 
                                        $table = "mnm yogurt milk";
                                        break;

                                    case 12: 
                                        $table = "mnm classic milktea";
                                        break;
