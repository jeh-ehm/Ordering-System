...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="left-sidebar">
            ...
            <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                      ...
                      <li> <a href="all_menu.php" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">All Menu</span></a>
</li>
                      <li> <a href="add_menu.php" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Add Menu</span></a>
</li> <ul aria-expanded="false" class="collapse">
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer"> © 2022 - Ordering System </footer>
